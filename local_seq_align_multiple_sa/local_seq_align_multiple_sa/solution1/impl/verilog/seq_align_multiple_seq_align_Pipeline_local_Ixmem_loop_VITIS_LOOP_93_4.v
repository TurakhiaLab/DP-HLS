...
module seq_align_multiple_seq_align_Pipeline_local_Ixmem_loop_VITIS_LOOP_93_4 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] icmp_ln92_fu_951_p2;
reg    ap_condition_exit_pp0_iter0_stage0;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
reg   [5:0] nn_fu_228;
wire   [5:0] add_ln93_fu_1320_p2;
wire    ap_loop_init;
reg   [5:0] ap_sig_allocacmp_nn_load;
reg   [1:0] mm_fu_232;
wire   [1:0] select_ln92_1_fu_989_p3;
reg   [1:0] ap_sig_allocacmp_mm_load;
reg   [6:0] indvar_flatten139_fu_236;
wire   [6:0] add_ln92_1_fu_957_p2;
reg   [6:0] ap_sig_allocacmp_indvar_flatten139_load;
wire   [0:0] icmp_ln93_fu_975_p2;
wire   [1:0] add_ln92_fu_969_p2;
wire   [5:0] select_ln92_fu_981_p3;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        if ((icmp_ln92_fu_951_p2 == 1'd0)) begin
            indvar_flatten139_fu_236 <= add_ln92_1_fu_957_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            indvar_flatten139_fu_236 <= 7'd0;
        end
    end
end
...
always @ (*) begin
    if (((ap_start_int == 1'b1) & (icmp_ln92_fu_951_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_indvar_flatten139_load = 7'd0;
    end else begin
...
assign add_ln92_1_fu_957_p2 = (ap_sig_allocacmp_indvar_flatten139_load + 7'd1);

assign add_ln92_fu_969_p2 = (ap_sig_allocacmp_mm_load + 2'd1);

assign add_ln93_fu_1320_p2 = (select_ln92_fu_981_p3 + 6'd1);
...
assign icmp_ln92_fu_951_p2 = ((ap_sig_allocacmp_indvar_flatten139_load == 7'd64) ? 1'b1 : 1'b0);

assign icmp_ln93_fu_975_p2 = ((ap_sig_allocacmp_nn_load == 6'd32) ? 1'b1 : 1'b0);
...
assign select_ln92_1_fu_989_p3 = ((icmp_ln93_fu_975_p2[0:0] == 1'b1) ? add_ln92_fu_969_p2 : ap_sig_allocacmp_mm_load);

assign select_ln92_fu_981_p3 = ((icmp_ln93_fu_975_p2[0:0] == 1'b1) ? 6'd0 : ap_sig_allocacmp_nn_load);

endmodule //seq_align_multiple_seq_align_Pipeline_local_Ixmem_loop_VITIS_LOOP_93_4
