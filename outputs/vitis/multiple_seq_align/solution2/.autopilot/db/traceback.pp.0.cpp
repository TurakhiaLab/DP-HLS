# 1 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.cpp" 2
# 1 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.h" 1
...
# 5 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.h" 2
...
# 6 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.h" 2

using namespace hls;

class TraceBack {
public:
    tbp_t tb_matrix[4][32*32/4];
    int input_ptr[2];
...
#pragma HLS bind_storage variable=tb_matrix type=RAM_1P impl=bram
    ...
    int traceback(stream<tbp_t, 32 +32> &tb_stream, int max_row, int max_col);

};
# 2 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.cpp" 2
# 1 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/loop_counter.h" 1
...
# 3 "/home/yic033@AD.UCSD.EDU/DP-HLS/outputs/src/traceback.cpp" 2
...
int TraceBack::traceback(stream<tbp_t, 32 + 32> &tb_stream, int max_row, int max_col)
{
    int stream_ctr = 0;
    int row_ctr = max_row;
    int col_ctr = max_col;
    LoopCounter<4> pe_ctr(max_row % 4);

    int arr_idx = (max_row / 4) * 32 + max_col;

    tbp_t tmp;

    VITIS_LOOP_23_1: for (int i = 0; i < 32 + 32; i++)
    {
