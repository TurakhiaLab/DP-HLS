...
#define MAX_QUERY_LENGTH 256   // This is read length in SF
#define MAX_REFERENCE_LENGTH 256  // This is Reference length in SF, supposted to be 60000
...
#define N_BLOCKS 1
#define N_LAYERS 1
#define PE_NUM 32  // this is equivalent to the query_length in Squiggle Filter (they use query_length to means the number of PE, because they requires query_length as exactly 2000, which is also the number of PEs).
