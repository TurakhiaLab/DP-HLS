...
typedef ap_uint<8> char_t;  // Sequence Alphabet, 8 bits unsigned integers
typedef ap_uint<15> type_t;  // this is 10 + 16 (5) = 26 (5) for length 60000 sequence
